...
SUMMARY = "link-mINK jrpcd set of init scripts for systemd init style"
LICENSE = "MIT"
...
SYSTEMD_SERVICE_${PN} = "jrpcd.service"

FILES:${PN}:append = " ${systemd_system_unitdir}/jrpcd.service"
