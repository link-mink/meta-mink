...
SUMMARY = "link-mINK routingd set of init scripts for systemd init style"
LICENSE = "MIT"
...
SYSTEMD_SERVICE_${PN} = "routingd.service"

FILES:${PN}:append = " ${systemd_system_unitdir}/routingd.service"
